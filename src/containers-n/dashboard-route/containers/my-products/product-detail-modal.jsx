    ...
    render() {
        ...
        return (
            <Modal isOpen={is_open} toggle={toggle} size="xl" backdrop="static" className="product-detail-modal">
                <ModalHeader toggle={toggle}>Detail of product status</ModalHeader>
                <ModalBody>
                    ...
                    <TableWithItemPattern
                        ...
                        titles={['Platform', 'Status', 'Error detail', 'QC detail']}
...
function ProductDetailTableItem({item}) {
    return (
        <tr>
            ...
            <td className={item.error_detail ? 'text-danger' : 'text-secondary'}>{item.error_detail || 'No error'}</td>
            <td className={item.qc_reason ? 'text-danger' : 'text-secondary'}>{item.qc_reason || 'None'}</td>
        </tr>
    );
}
...
function ProductDetailStatusCell({status}) {
    return {
        ...
        'Tiki': <div className="product-detail-status-cell">
            ...
            <span>Product request status</span>
            {
